...
const PRIORITY_STYLE: Record<CasePriority, { bg: string; text: string; label: string; dot: string }> = {
...
export const PRIORITY_LABEL: Record<CasePriority, string> = Object.fromEntries(
  Object.entries(PRIORITY_STYLE).map(([k, v]) => [k, v.label]),
) as unknown as Record<CasePriority, string>;

export function PriorityChip({ priority, size = "md" }: { priority: CasePriority; size?: "sm" | "md" }) {
